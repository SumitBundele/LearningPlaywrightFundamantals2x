        ...
        for (const test of this.testResults) {
            ...
            html += `
                <tr class="test-row ${statusClass}" data-test-id="${test.id}" data-tags="${tagsData}">
                    ...
                    <td class="col-video">
                        ${test.video ? `<a href="${test.video}" target="_blank" download class="video-link-cell">▶️ Play</a>` : 'N/A'}
                    </td>
                    <td class="col-trace">
        ...
        if (test.video) {
            ...
            <div class="detail-section videos-section">
                ...
                <div class="section-content">
                    ...
                    <div class="video-link"><a href="${test.video}" target="_blank" download>📎 video</a></div>
                </div>
            </div>`;
        }
