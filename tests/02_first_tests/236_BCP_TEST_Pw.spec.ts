...
test("two users interact", async ({ browser }) => { //inject browser 
    let adminContext = await browser.newContext(); //create context
    let adminPage = await adminContext.newPage();//create page 
