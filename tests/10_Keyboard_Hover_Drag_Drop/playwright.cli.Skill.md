# Playwright CLI - Agent CLI Introduction

> Source: https://playwright.dev/agent-cli/introduction
...
## Table of Contents (Full Docs)

- **Getting Started**
  - [Installation](/agent-cli/installation)
  - [Quick Start](/agent-cli/quick-start)
  - [Skills](/agent-cli/skills)
- **Core Concepts**
  - [Snapshots](/agent-cli/snapshots)
  - [Capabilities](/agent-cli/capabilities)
  - [Vision Mode](/agent-cli/vision-mode)
- **Browser Automation**
  - [Navigation](/agent-cli/commands/navigation)
  - [Interaction](/agent-cli/commands/interaction)
  - [Keyboard & Mouse](/agent-cli/commands/keyboard-mouse)
  - [Tabs](/agent-cli/commands/tabs)
  - [Dialogs](/agent-cli/commands/dialogs)
- **Network & Storage**
  - [Network & Mocking](/agent-cli/commands/network-routing)
  - [Storage & Authentication](/agent-cli/commands/storage)
- **Developer Tools**
  - [Console & Eval](/agent-cli/commands/console-eval)
  - [Screenshots & PDF](/agent-cli/commands/screenshots-pdf)
  - [Tracing](/agent-cli/commands/tracing)
  - [Test Debugging](/agent-cli/commands/test-debugging)
- **Video Recording**
- **Sessions**
  - [Sessions & Dashboard](/agent-cli/sessions)
  - [Attach](/agent-cli/commands/attach)
- [Configuration](/agent-cli/configuration)
